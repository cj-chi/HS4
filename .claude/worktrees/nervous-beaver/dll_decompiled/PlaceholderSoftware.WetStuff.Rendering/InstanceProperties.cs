...
internal struct InstanceProperties
{
	...
	public void LoadInto(int index, [NotNull] float[] saturation, [NotNull] float[] fadeout, [NotNull] float[] edgeSharpness, LayerArrays? x, LayerArrays? y, LayerArrays? z)
	{
	...
	public static void LoadInto([NotNull] MaterialPropertyBlock properties, [NotNull] float[] saturation, [NotNull] float[] fadeout, [NotNull] float[] edgeSharpness, LayerArrays? x, LayerArrays? y, LayerArrays? z)
	{
