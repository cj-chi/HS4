...
public class SpecialTreatmentRoomManager1 : Singleton<SpecialTreatmentRoomManager1>
{
	public enum Mode
	{
		Main,
	...
	[Header("制御スクリプト")]
	[SerializeField]
	private STRMainMenu1 _mainMenu;

	[SerializeField]
	private STRPlanSelect1 _planSelect;

	[SerializeField]
	private STRConfirmation1 _confirmation;

	private Controller ctrl;

	private Dictionary<int, HomeCameraInfo.Param> dicCameraInfo = new Dictionary<int, HomeCameraInfo.Param>();

	private STRActionInfoData1 actionInfoData;
	...
	public STRMainMenu1 MainMenu => _mainMenu;

	public STRPlanSelect1 PlanSelect => _planSelect;

	public STRConfirmation1 Confirmation => _confirmation;
	...
	public STRActionInfoData1 ActionInfoData => actionInfoData;
	...
	private IEnumerator Start()
	{
		...
		actionInfoData = GlobalMethod.LoadAllFolderInOneFile<STRActionInfoData1>(AssetBundleNames.SprPrefabsPath, "stractioninfodata", null, _subdirCheck: true);
