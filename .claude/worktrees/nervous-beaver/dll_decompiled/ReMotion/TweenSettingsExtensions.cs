...
public static class TweenSettingsExtensions
{
	...
	{
		public Int32Tween(TweenSettings settings, TObject target, TweenGetter<TObject, int> getter, TweenSetter<TObject, int> setter, EasingFunction easingFunction, float duration, int to, bool isRelative)
			: base(settings, target, getter, setter, easingFunction, duration, to, isRelative)
		{
		}
	...
	{
		public Int64Tween(TweenSettings settings, TObject target, TweenGetter<TObject, long> getter, TweenSetter<TObject, long> setter, EasingFunction easingFunction, float duration, long to, bool isRelative)
			: base(settings, target, getter, setter, easingFunction, duration, to, isRelative)
		{
		}
	...
	{
		public UInt32Tween(TweenSettings settings, TObject target, TweenGetter<TObject, uint> getter, TweenSetter<TObject, uint> setter, EasingFunction easingFunction, float duration, uint to, bool isRelative)
			: base(settings, target, getter, setter, easingFunction, duration, to, isRelative)
		{
		}
		...
		{
			value = (uint)((float)from + (float)difference * ratio);
		}
	}

	private class UInt64Tween<TObject> : Tween<TObject, ulong> where TObject : class
	{
		public UInt64Tween(TweenSettings settings, TObject target, TweenGetter<TObject, ulong> getter, TweenSetter<TObject, ulong> setter, EasingFunction easingFunction, float duration, ulong to, bool isRelative)
			: base(settings, target, getter, setter, easingFunction, duration, to, isRelative)
		{
		}
		...
		{
			value = (ulong)((float)from + (float)difference * ratio);
		}
	}
