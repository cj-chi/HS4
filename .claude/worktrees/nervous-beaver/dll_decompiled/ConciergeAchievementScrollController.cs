...
[Serializable]
public class ConciergeAchievementScrollController
{
	public class RowData
	{
		...
		public ConciergeAchievementInfoComponent.RowInfo row;
	...
	public void UpdateNowDraw()
	{
		for (int i = 0; i < view.ShownItemCount; i++)
		{
			...
			{
				ConciergeAchievementInfoComponent component = shownItemByIndex.GetComponent<ConciergeAchievementInfoComponent>();
	...
	private LoopListViewItem2 OnUpdate(LoopListView2 _view, int _index)
	{
		...
		ConciergeAchievementInfoComponent component = loopListViewItem.GetComponent<ConciergeAchievementInfoComponent>();
