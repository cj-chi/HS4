...
[Serializable]
public class LobbyCharaSelectInfoScrollController1
{
	public class RowData
	{
		public int line = -1;

		public LobbyCharaSelectInfoComponent1.RowInfo row;
	...
	private LoopListViewItem2 OnUpdate(LoopListView2 _view, int _index)
	{
		...
		LobbyCharaSelectInfoComponent1 component = loopListViewItem.GetComponent<LobbyCharaSelectInfoComponent1>();
