...
internal struct MaterialProperties : IEquatable<MaterialProperties>
{
	...
	public MaterialProperties(Texture2D xLayer, Vector4 xLayerScaleOffset, Texture2D yLayer, Vector4 yLayerScaleOffset, Texture2D zLayer, Vector4 zLayerScaleOffset, Texture2D blueNoiseRgba, Vector2 randomnessTiling, Vector2 sampleJitter)
	{
		XLayer = xLayer;
	...
	public override bool Equals(object obj)
	{
		...
		{
			return Equals((MaterialProperties)obj);
		}
		return false;
	}
	...
	{
		if (EqualityComparer<Vector4>.Default.Equals(XLayerScaleOffset, other.XLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(XLayer, other.XLayer) && EqualityComparer<Vector4>.Default.Equals(YLayerScaleOffset, other.YLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(YLayer, other.YLayer) && EqualityComparer<Vector4>.Default.Equals(ZLayerScaleOffset, other.ZLayerScaleOffset) && EqualityComparer<Texture2D>.Default.Equals(ZLayer, other.ZLayer) && EqualityComparer<Texture2D>.Default.Equals(BlueNoiseRgba, other.BlueNoiseRgba) && EqualityComparer<Vector2>.Default.Equals(RandomnessTiling, other.RandomnessTiling))
		{
			return EqualityComparer<Vector2>.Default.Equals(SampleJitter, other.SampleJitter);
		}
		return false;
	}
	...
	{
		return ((((((((47332817 * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(XLayerScaleOffset)) * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(XLayer)) * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(YLayerScaleOffset)) * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(YLayer)) * -1521134295 + EqualityComparer<Vector4>.Default.GetHashCode(ZLayerScaleOffset)) * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(ZLayer)) * -1521134295 + EqualityComparer<Texture2D>.Default.GetHashCode(BlueNoiseRgba)) * -1521134295 + EqualityComparer<Vector2>.Default.GetHashCode(RandomnessTiling)) * -1521134295 + EqualityComparer<Vector2>.Default.GetHashCode(SampleJitter);
	}
