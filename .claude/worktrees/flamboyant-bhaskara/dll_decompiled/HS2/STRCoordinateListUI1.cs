...
public class STRCoordinateListUI1 : MonoBehaviour
{
	[SerializeField]
	...
	[SerializeField]
	private STRCoordinateFileScrollController1 listCtrl = new STRCoordinateFileScrollController1();

	private List<STRCoordinateFileInfo1> charaLists = new List<STRCoordinateFileInfo1>();

	public STRCoordinateFileScrollController1 ListCtrl => listCtrl;
	...
	public void CreateList()
	{
		...
		charaLists = STRCoordinateFileInfoAssist1.CreateCharaFileInfoList(num);
		SortDate(tglSort.isOn);
	}
