...
public class STRCoordinateFileInfoComponent : MonoBehaviour
{
	[Serializable]
	...
	public void SetData(int _index, STRCoordinateFileInfo _info, Action<bool> _onClickAction, bool _isAllnteractable)
	{
	...
	public STRCoordinateFileInfo GetListInfo(int _index)
	{
		return rows[_index].info;
	}

	public void SetListInfo(int _index, STRCoordinateFileInfo _info)
	{
		rows[_index].info = _info;
	}
