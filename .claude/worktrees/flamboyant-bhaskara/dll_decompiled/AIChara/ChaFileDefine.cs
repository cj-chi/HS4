...
public static class ChaFileDefine
{
	...
	public const string SitriFileName = "sitri";
	...
	public static readonly int[] cf_BustShapeMaskID = new int[8] { 2, 3, 4, 5, 6, 7, 8, 32 };

	public static readonly int[] cf_ShapeMaskBust = new int[5] { 0, 1, 2, 3, 4 };

	public static readonly int[] cf_ShapeMaskNip = new int[2] { 5, 6 };
	...
	public static readonly string[] cf_headshapename = new string[59]
	{
		...
		"顎先幅", "顎先上下", "顎先前後", "頬下部上下", "頬下部前後", "頬下部幅", "頬上部上下", "頬上部前後", "頬上部幅", "目上下",
		"目横位置", "目前後", "目の横幅", "目の縦幅", "目の角度Z軸", "目の角度Y軸", "目頭左右位置", "目尻左右位置", "目頭上下位置", "目尻上下位置",
		"まぶた形状１", "まぶた形状２", "鼻全体上下", "鼻全体前後", "鼻全体角度X軸", "鼻全体横幅", "鼻筋高さ", "鼻筋横幅", "鼻筋形状", "小鼻横幅",
		"小鼻上下", "小鼻前後", "小鼻角度X軸", "小鼻角度Z軸", "鼻先高さ", "鼻先角度X軸", "鼻先サイズ", "口上下", "口横幅", "口縦幅",
		"口前後位置", "口形状上", "口形状下", "口形状口角", "耳サイズ", "耳角度Y軸", "耳角度Z軸", "耳上部形状", "耳下部形状"
	};

	public static readonly int[] cf_MouthShapeMaskID = new int[13]
	{
		3, 6, 11, 47, 48, 49, 50, 51, 52, 53,
		5, 10, 12
	};

	public static readonly float[] cf_MouthShapeDefault = new float[13]
	{
		0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f,
		0.5f, 0.5f, 0.5f
	};
	...
	public static readonly string[] cp_statename = new string[7] { "普通", "好意", "享楽", "嫌悪", "隷属", "壊れ", "依存" };
	...
	public static string GetBirthdayStr(int month, int day, GameSystem.Language culture = GameSystem.Language.Japanese)
	{
		string result = "";
		switch (culture)
		{
