...
[Serializable]
public class FurRoomAchievementItemScrollController
{
	public class RowData
	{
		public int line = -1;

		public FurRoomAchievementItemInfoComponent.RowInfo row;
	...
	private LoopListViewItem2 OnUpdate(LoopListView2 _view, int _index)
	{
		...
		FurRoomAchievementItemInfoComponent component = loopListViewItem.GetComponent<FurRoomAchievementItemInfoComponent>();
