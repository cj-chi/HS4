...
public class UploadScene : MonoBehaviour
{
	...
	[SerializeField]
	private UploaderCultureControl cultureCtrl;
	...
	private IEnumerator Start()
	{
		...
		if (null != cultureCtrl)
		{
			cultureCtrl.ChangeLocalize(MyLocalizeDefine.LocalizeKeyType.Uploader, Singleton<GameSystem>.Instance.languageInt);
		}
		Observable.FromCoroutine(() => phpCtrl.GetBaseInfo(upload: true)).Subscribe(delegate
		{
		}, delegate
		{
		}, delegate
		{
			uiCtrl.UpdateProfile();
		});
