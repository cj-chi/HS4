...
public class UploaderCultureControl : CultureControl
{
	protected override void Reset()
	{
		...
		Image[] array = (from img in GetComponentsInChildren<Image>(includeInactive: true)
			where img.gameObject.name == "imgEntry" || img.gameObject.name == "imgCautionCopyright" || img.gameObject.name == "imgCautionPolicy" || img.gameObject.name == "imgPolicy" || img.gameObject.name == "imgPolicyH"
			select img).ToArray();
