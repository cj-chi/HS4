...
public class ObiCharacter : MonoBehaviour
{
	...
	private ObiAnimatorController m_AnimatorController;
	...
	{
		if (m_IsGrounded && (m_AnimatorController == null || m_AnimatorController.UpdateDelta > 0f))
		{
			Vector3 velocity = m_Animator.deltaPosition * m_MoveSpeedMultiplier / ((m_AnimatorController == null) ? Time.deltaTime : m_AnimatorController.UpdateDelta);
