...
[Serializable]
public class DecalSettingsDataContainer : TemplatedTimeline<DecalSettingsDataContainer, DecalSettingsClip, DecalSettingsMixer, DecalSettingsTrack, DecalSettingsDataContainer.DecalSettingsData, WetDecal>.BaseData
{
	[Serializable]
	public struct DecalSettingsData
	{
		...
		[SerializeField]
		[UsedImplicitly]
		public DecalLayerData XLayer;

		[SerializeField]
		[UsedImplicitly]
		public DecalLayerData YLayer;

		[SerializeField]
		[UsedImplicitly]
		public DecalLayerData ZLayer;
	...
	public struct DecalLayerData
	{
		[SerializeField]
		[UsedImplicitly]
		public DecalLayerChannelData Channel1;

		[SerializeField]
		[UsedImplicitly]
		public DecalLayerChannelData Channel2;

		[SerializeField]
		[UsedImplicitly]
		public DecalLayerChannelData Channel3;

		[SerializeField]
		[UsedImplicitly]
		public DecalLayerChannelData Channel4;
