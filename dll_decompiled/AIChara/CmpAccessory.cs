	...
	public void SetColor()
	{
		if (rendNormal != null && rendNormal.Length != 0)
		{
			...
			if (null != sharedMaterial)
			{
				...
				{
					defGlossPower01 = sharedMaterial.GetFloat("_Glossiness");
				}
				if (sharedMaterial.HasProperty("_Metallic"))
				{
					defMetallicPower01 = sharedMaterial.GetFloat("_Metallic");
				}
				...
				{
					defGlossPower02 = sharedMaterial.GetFloat("_Glossiness2");
				}
				if (sharedMaterial.HasProperty("_Metallic2"))
				{
					defMetallicPower02 = sharedMaterial.GetFloat("_Metallic2");
				}
				...
				{
					defGlossPower03 = sharedMaterial.GetFloat("_Glossiness3");
				}
				if (sharedMaterial.HasProperty("_Metallic3"))
				{
					defMetallicPower03 = sharedMaterial.GetFloat("_Metallic3");
				}
			}
		}
		...
		if (null != sharedMaterial2)
		{
			...
			{
				defColor04 = sharedMaterial2.GetColor("_Color");
			}
			if (sharedMaterial2.HasProperty("_Glossiness4"))
			{
				defGlossPower04 = sharedMaterial2.GetFloat("_Glossiness4");
			}
			if (sharedMaterial2.HasProperty("_Metallic4"))
			{
				defMetallicPower04 = sharedMaterial2.GetFloat("_Metallic4");
			}
		}
	}
}
