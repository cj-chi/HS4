...
public class SpecialTreatmentRoomShortcutKey1 : MonoBehaviour
{
	private IEnumerator Start()
	{
			...
			select _).Subscribe(delegate
		{
			...
			else if (Input.GetKeyDown(KeyCode.F3) && Singleton<Game>.Instance.appendSaveData.AppendTutorialNo == -1)
			{
