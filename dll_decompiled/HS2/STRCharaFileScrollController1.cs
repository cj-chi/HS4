...
[Serializable]
public class STRCharaFileScrollController1
{
	public class RowData
	{
		...
		public STRCharaFileInfoComponent1.RowInfo row;
	...
	public Action<STRCharaFileInfo1> onSelect;
	...
	public void Init(List<STRCharaFileInfo1> _lst)
	{
		scrollerDatas = _lst.Select((STRCharaFileInfo1 value, int idx) => new ScrollData
		{
			index = idx,
			info = value
		}).ToArray();
	...
	public STRCharaFileInfo1 FindInfoByFileName(string _fileName)
	{
	...
	public void SetNowSelectToggle()
	{
		for (int i = 0; i < view.ShownItemCount; i++)
		{
			...
			{
				STRCharaFileInfoComponent1 component = shownItemByIndex.GetComponent<STRCharaFileInfoComponent1>();
	...
	private bool IsNowSelectInfo(STRCharaFileInfo1 _info)
	{
	...
	private LoopListViewItem2 OnUpdate(LoopListView2 _view, int _index)
	{
		...
		STRCharaFileInfoComponent1 component = loopListViewItem.GetComponent<STRCharaFileInfoComponent1>();
