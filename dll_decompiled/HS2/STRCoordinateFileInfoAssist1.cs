...
public class STRCoordinateFileInfoAssist1
{
	private static void AddList(List<STRCoordinateFileInfo1> _list, string path)
	{
		...
		for (int i = 0; i < fileCount; i++)
		{
			...
			_list.Add(new STRCoordinateFileInfo1
			{
				index = num++,
	...
	public static List<STRCoordinateFileInfo1> CreateCharaFileInfoList(int _sex)
	{
		List<STRCoordinateFileInfo1> list = new List<STRCoordinateFileInfo1>();
